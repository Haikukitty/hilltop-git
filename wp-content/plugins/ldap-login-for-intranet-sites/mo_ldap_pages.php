...
function mo_ldap_local_settings() {
	...
	<div class="mo2f_container">
		...
		<h2 class="nav-tab-wrapper">
			...
			<!--<a id="ldap_licensing_tab_pointer" style="position: relative" class="nav-tab <?php /*echo $active_tab == 'pricing' ? 'nav-tab-active' : ''; */?>" href="<?php /*echo add_query_arg( array('tab' => 'pricing'), $_SERVER['REQUEST_URI'] ); */?>">Licensing Plans</a>-->
        ...
        <?php }else if ( $active_tab == 'pricing' ){ ?>
				...
				<div id="panel1">
					<table class="mo_ldap_settings_table">
						<tr>
							...
							<td><div id="ldap_server_url_pointer" style="position: relative;border-radius: 10px"><input class="mo_ldap_table_textbox <?php echo $mo_ldap_local_server_url_status; ?>" type="url" id="ldap_server" name="ldap_server" required placeholder="ldap://<server_address or IP>:<port>" value="<?php echo $server_url?>" /></div></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
						...
						<tr>
                            ...
                            <td>
                                ...
                                <input type="checkbox" name="anonymous_bind" value="1" <?php checked(get_option('mo_ldap_local_anonymous_bind') == 1);?> onchange="enable(this)">Bind anonymously (to check connection to server).
                            </td>
                            <td> </td>
                        </tr>
                        <tr><td>  </td></tr>
						...
						<tr>
							<td>&nbsp;</td>
							<td><i>This service account username will be used to establish the connection.<br>Specify the Service Account Username of the LDAP server in the either way as follows<b> Username@domainname or domainname\Username. or Distinguished Name(DN) format</b></i></td>
						</tr>
						<tr><td>&nbsp;</td></tr>
						<tr>
				...
				<div id="panel1">
					<table class="mo_ldap_settings_table">
						...
						<tr>
							...
							<td><div id="search_filter_ldap" style="position: relative;line-height: 5;  "><input class="mo_ldap_table_textbox <?php echo $mo_ldap_local_user_mapping_status; ?>" type="text" id="search_filter" name="search_filter" required placeholder="eg. mail"  value="<?php echo get_option('Filter_search') ?>"
							/></div></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
	...
	?><div class="mo_ldap_support_layout">
		<div> <span id="export-config-service-restart-tour" style="position: relative; float:right; padding-bottom: 14px;padding-top:14px;background: white;border-radius: 10px;">
            ...
            <form method="post",action="">
                ...
                <table><tr><td><input type="checkbox" id = "enable_save_config" name="enable_save_config" value="1" onchange="this.form.submit()" <?php checked(get_option('en_save_config') == 1);?> />Persist configuration upon uninstall.
                        </td></tr></table>
			...
			<form method="post" action="" name="mo_export_pass">
				...
				<table>
					...
					<tr><td><input type="checkbox" id="enable_ldap_login" name="enable_ldap_login" value="1" onchange="this.form.submit()" <?php checked(get_option('mo_ldap_export') == 1);?> />Export Service Account password. (This will lead to your service account password to be exported in encrypted fashion in a file)</td>
...
<div class="mo_ldap_small_layout" style="margin-top:0px;">
    ...
    <form name="f" id="enable_role_mapping_form" method="post" action="">
        ...
        <h3>Default Role Mapping <sup style="font-size: 12px;">[Available in the current Version]</sup></h3>
        <table><tr><td><input type="checkbox" id="enable_ldap_role_mapping" name="enable_ldap_role_mapping"  value="1" <?php checked(get_option('mo_ldap_local_enable_role_mapping') == 1);?>/>Enable Role Mapping</td></tr></table>
    ...
    <div class="mo_ldap_small_layout" style="">
        <form name="mo_ldap_fetch_groups_form" method="post" action="" id="mo_ldap_fetch_groups_form">
            <h3>Fetch Groups Information<sup style="font-size: 12px">[Available in <a href="<?php echo add_query_arg( array('tab' => 'pricing'), $_SERVER['REQUEST_URI'] ); ?>">Premium version </a> of the plugin.]</sup></h3>Enter container for groups
    ...
    <div class="mo_ldap_small_layout" style="">
        <table class="mo_ldap_mapping_table" id="ldap_role_mapping_table" style="width:90%">
                        <tr><td><h3>LDAP Groups to WP User Role Mapping <sup style="font-size: 12px">[Available in <a href="<?php echo add_query_arg( array('tab' => 'pricing'), $_SERVER['REQUEST_URI'] ); ?>">Premium version </a> of the plugin.]</sup></h3></td></tr>
						<tr>
						...
						<tr>
							<td><input class="mo_ldap_table_textbox" type="text" name="mapping_key_<?php echo $i;?>"
								 value="<?php echo get_option('mo_ldap_local_mapping_key_'.$i);?>"  style="background: #DCDAD1;" placeholder="cn=group,dc=domain,dc=com"  />
							</td>
							<td>
			...
			<form method="post" id="rolemappingtest">
				<h3>Test Role Mapping Configuration <sup style="font-size: 12px">[Available in <a href="<?php echo add_query_arg( array('tab' => 'pricing'), $_SERVER['REQUEST_URI'] ); ?>">Premium version </a> of the plugin.]</sup></h3>Enter LDAP username to test role mapping configuration
...
<script>
		jQuery( document ).ready(function() {
                ...
                jQuery('#default_group_mapping').prop("disabled",false);
                jQuery('#add_mapping').prop("disabled",true);
                jQuery('#save-default-mapping').prop("disabled",false);
			...
			<form name="f" method="post" id="attribute_config_form">
				<table id="attributes_table" class="mo_ldap_settings_table">
						...
						<tr>
							...
							<td><div id="ldap_intranet_attribute_mail_name" style="position: relative;border-radius: 10px;"><input type="text" name="mo_ldap_email_attribute" required placeholder="Enter Email attribute" style="width:80%;"
							value="<?php echo get_option('mo_ldap_local_email_attribute');?>"/></div></td>
						</tr>
						<tr>
							...
							value="" <?php if(get_option('mo_ldap_local_cust', '1') == '0') echo "disabled"?>/></div></td>
						</tr>
						<tr>
							...
							value="" <?php if(get_option('mo_ldap_local_cust', '1') == '0') echo "disabled"?>/></td>
						</tr>
						<tr>
    ...
    <div class="mo_ldap_table_layout">
        <h2>Licensing Plans
            <span style="float:right;margin-right:15px;"><input type="button" name="ok_btn"
                                                                class="button button-primary button-large"
                                                                value="OK, Got It"
                                                                onclick="window.location.href='admin.php?page=mo_ldap_local_login&mo2f_tab=default'"/></span>
        </h2>
        <table class="table mo_table-bordered mo_table-striped">
            ...
            <tr style="background-color:#93ca3a;">
                ...
                <th class="text-center" width="25%"><h3>Free <br><br><br></h3><p class="mo_plan-desc"></p><h3><b>(You are automatically on this plan)</b><br><br><br><span></span></h3></th>
                <th class="text-center" width="25%"><h3>Standard<br><br><br></h3><p class="mo_plan-desc"></p><h3><b>$119/per instance</b><br><br><span>
                <label>Total Price(In USD)</label><br/><br/>
                <span id="standard_total_price" style="font-weight: bolder;font-size: larger"></span><br/><br/>
                <input type="button" name="upgrade_btn" class="button button-default button-large" value="Upgrade Now"
                       onclick="upgradeform('wp_ldap_intranet_basic_plan')"/><br /><br />
                 <input type="radio" name="standard_radio_button" value="" id="standard_single_site_radio_button" checked >Single Site
                 <input type="radio" name="standard_radio_button" value="" id="standard_multi_site_radio_button">Multi Site<br/><br/>
                  <div id="standard_no_of_instances_drop_down_div" name="standard_no_of_instances_drop_down_div">
                      <label>No of Instances</label><br/>
                  <select style="width: 90%;" id="standard_no_of_instances_drop_down" name="standard_no_of_instances_drop_down">
                         <option value="1" data-value="0">1 instance </option>
                        ...
                        <br/>
                    <div id="standard_number_of_subsites_dropdown_div" name="standard_no_of_instances_drop_down_div">
                        <label>No of Subsites</label>
                ...
                <th class="text-center" width="25%"><h3>Enterprise<br><br><br></h3><h3><b>$199/per instance</b><br/><br/><span>
                <label>Total Price(In USD)</label><br/><br/>
                <span id="enterprise_total_price" style="font-weight: bolder;font-size: larger"></span><br/><br/>
				<input type="button" name="upgrade_btn" class="button button-default button-large" value="Upgrade Now"
                       onclick="upgradeform('wp_ldap_intranet_premium_plan')"/><br /><br />
                 <input type="radio" name="enterprise_radio_button" value="" id="enterprise_single_site_radio_button" checked >Single Site
                 <input type="radio" name="enterprise_radio_button" value="" id="enterprise_multi_site_radio_button">Multi Site<br/><br/>
                <div id="enterprise_no_of_instances_drop_down_div" name="enterprise_no_of_instances_drop_down_div">
                      <label>No of Instances</label><br/>
                  <select style="width: 90%;" id="enterprise_no_of_instances_drop_down" name="enterprise_no_of_instances_drop_down">
                         <option value="1" data-value="0">1 instance </option>
                                <option value="2">2 instances</option>
                                <option value="3">3 instances</option>
                                <option value="4">4 instances</option>
                        ...
                        <br/>
                    <div id="enterprise_number_of_subsites_dropdown_div" name="enterprise_no_of_instances_drop_down_div">
                        <label>No of Subsites</label>
                    <select style="width: 90%" id="enterprise_number_of_subsites_dropdown" name="enterprise_number_of_subsites_dropdown">
                        <option value="3">$45 - Upto 3 Subsites / Instance</option>
                        <option value="5">$60 - Upto 5 Subsites / Instance</option>
                        <option value="10">$120 - Upto 10 Subsites / Instance</option>
                        <option value="15">$160 - Upto 15 Subsites / Instance</option>
            ...
            <tr>
                <td>Unlimited LDAP Authentications</td>
            ...
            <tr>
                <td>Role Mapping</td>
                <td><i>Basic Role Mapping</i></td>
                <td><i>Customized Role Mapping</i></td>
                <td><i>Customized Role Mapping</i></td>
            </tr>
            <tr>
                <td>Attribute Mapping</td>
                <td><i>Basic Attribute Mapping</i></td>
                <td><i>Customized Attribute Mapping</i></td>
                <td><i>Customized Attribute Mapping</i></td>
            </tr>
            <tr>
                <td>Number of LDAP Directories</td>
                <td><i>1</i></td>
                <td><i>1</i></td>
                <td><i><b>2</b></i></td>
            </tr>
            <tr>
                <td>Multiple Search Bases</td>
                <td><i></i></td>
                <td><i class="fa fa-check"></i></td>
                <td><i class="fa fa-check"></i></td>
            </tr>
            <tr>
                <td>Sync LDAP Profile with WordPress upon login</td>
                <td><i></i></td>
                <td><i class="fa fa-check"></i></td>
                <td><i class="fa fa-check"></i></td>
            </tr>
            <tr>
                <td>Support for add-ons</td>
                <td><i></i></td>
                <td><i class="fa fa-check"></i></td>
                <td><i class="fa fa-check"></i></td>
            </tr>
        ...
        <table class="table mo_table-bordered mo_table-striped">
            <thead>
            <tr style="background-color:#93ca3a;">
                <th class="text-center" width="20%"><h3>Add-ons</h3></th>
                <th class="text-center" width="20%"><h3>Price</h3></th>
                <th class="text-center" width="20%"><h3>Buy</h3></th>
            </tr>
            </thead>
            <tbody class="mo_align-center mo-fa-icon">
            <tr>
                <td>Directory Sync Add-on</td>
                <td>$99</td>
                <td><a target="_blank" href="https://auth.miniorange.com/moas/login?redirectUrl=https://auth.miniorange.com/moas/initializepayment&requestOrigin=wp_directory_sync_plan">Buy</a></td>
            </tr>
            <tr>
                <td>LDAP Search Widget Add-on</td>
                <td>$99</td>
                <td><a target="_blank" href="https://www.miniorange.com/contact">Buy</a></td>
            </tr>
            <tr>
                <td>BuddyPress Extended Profiles Add-on</td>
                <td>$99</td>
                <td><a target="_blank" href="https://www.miniorange.com/contact">Buy</a></td>
            </tr>
            <tr>
                <td>Sync BuddyPress Groups Add-on</td>
                <td>$99</td>
                <td><a target="_blank" href="https://auth.miniorange.com/moas/login?redirectUrl=https://auth.miniorange.com/moas/initializepayment&requestOrigin=wp_ldap_intranet_buddypress_extended_profiles_plan">Buy</a></td>
            </tr>
            <tr>
                <td>Kerberos/NTLM SSO Add-on</td>
                <td>$99</td>
                <td><a target="_blank" href="	https://auth.miniorange.com/moas/login?redirectUrl=https://auth.miniorange.com/moas/initializepayment&requestOrigin=wp_ntlm_sso_plan">Buy</a></td>
            </tr>
            <tr>
                <td>Gravity Forms Add-on</td>
                <td>$99</td>
                <td><a target="_blank" href="https://www.miniorange.com/contact">Buy</a></td>
            </tr>
            <tr>
                <td>eMember Add-on</td>
                <td>$99</td>
                <td><a target="_blank" href="https://www.miniorange.com/contact">Buy</a></td>
            </tr>
            </tbody>
        ...
        <h3>1.Directory Sync Add-on -</h3>
        <p>Wordpress users will be synced with LDAP and vice versa. Schedules can be configured for the sync to run at a specific time and after a specific interval. These are available after separate purchase. Please use the link above to purchase.</p>

        <h3>2.LDAP Search Widget Add-on -</h3>
        <p>You can search your directory users on your website. These are available after separate purchase. Please contact us if you want this functionality.
        </p>

        <h3>3.BuddyPress Extended Profiles Add-on -</h3>
        <p>Integration with BuddyPress to sync extended profile of users with LDAP attributes upon login. These are available after separate purchase. Please use the link above to purchase.</p>

        <h3>4.Sync BuddyPress Groups Add-on -</h3>
        <p>Assign BuddyPress groups to users based on group membership in LDAP. These are available after separate purchase. Please contact us if you want this functionality.</p>

        <h3>5.Kerberos/NTLM SSO -</h3>
        <p>Allow auto-login into WordPress website if accessed from within the domain. These are available after separate purchase. Please use the link above to purchase.</p>

        <h3>6.Gravity Forms Integration -</h3>
        <p>Populate Gravity Form fields with information from LDAP. These are available after separate purchase. Please contact us if you want this functionality.
        </p>

        <h3>7.eMember Add-on -</h3>
        <p>Login to eMember profiles with LDAP Credentials.</p>
