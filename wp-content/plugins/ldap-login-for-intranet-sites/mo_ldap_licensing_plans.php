...
<!--                                <b style="color: coral;">See the free Plugin features list below</b>-->
                                <div class="cd-pricing-body">
                                    <ul class="cd-pricing-features">
                                        ...
                                        <li style="font-size: medium">Email and Username Mapping</li>
...
<!--                                                <option value="2" hidden>2 instances</option>-->
<!--                                                <option value="3" hidden>3 instances</option>-->
<!--                                                <option value="4" hidden>4 instances</option>-->
<!--                                                <option value="5" hidden>5 instances</option>-->
<!--                                                <option value="6" hidden>6 instances</option>-->
<!--                                                <option value="7" hidden>7 instances</option>-->
<!--                                                <option value="8" hidden>8 instances</option>-->
<!--                                                <option value="9" hidden>9 instances</option>-->
<!--                                                <option value="10" hidden>10 instances</option>-->
<!--                                                <option value="15" hidden>15 instances</option>-->
<!--                                                <option value="20" hidden>20 instances</option>-->
<!--                                                <option value="30" hidden>30 instances</option>-->
<!--                                                <option value="40" hidden>40 instances</option>-->
<!--                                                <option value="50" hidden>50 instances</option>-->
<!--                                                <option value="100" hidden>100 instances</option>-->
<!--                                                <option value="500" hidden>unlimited instances</option>-->
<!--                                            </select>-->
                                        </div>
...
<!--                                            <span class="cd-value">99*</span></span>-->
                                        ...
                                        </div><br><div id="multisite_basic_no_of_instances_drop_down_div" name="multisite_basic_no_of_instances_drop_down_div">
                                         <h3 style="margin-bottom: 10px" > For 1 instance<br/></h3>
...
<!--                                            </select>-->
                                ...
                                <!-- .cd-pricing-header -->
                                <footer class="cd-pricing-footer">
                                     <a href="https://www.miniorange.com/contact" class="cd-select" >Contact Us</a>
                                </footer><br>
<!--                                <b style="color: coral;">See the Multisite Premium Plugin features list below</b>-->
                                <div class="cd-pricing-body">
                            ...
                            <li id="singlesite_tab" data-type="singlesite" class="mosslp is-visible" style="border: <?php echo $sspborder; ?>">
                                <header class="cd-pricing-header" style="height: 230px">
                                        ...
                                        <div class="cd-price" ><br>
                                            <span id="plus_total_price" style="font-weight: bolder;font-size: xx-large">$179</span>
<!--                                            <span class="cd-currency">$</span>-->
                                ...
                                <a id="popover4" data-toggle="popover" title="<h3>Why should I choose this plan?</h3>" data-placement="top" data-html="true"
                                   data-content="<p>Choose this plan if you have Multisite Network installation and are looking for features like <br /><b>Add-ons</b> (See the list of add-ons below in the feature list) along with the features listed in the Premium Plan like <br /><b>Subsite Specific SSO<br />Auto-Redirect to IdP<br />Advance Attribute Mapping<br />Role Mapping<br />IdP metadata sync<br />Support of custom SP and IdP certificate</b></p>">
                                    <header class="cd-pricing-header" style="height: 282px">
                                     ...
                                     <div class="cd-price" >
                                        <div class="cd-price" ><br>
                                            <span id="multisite_plus_total_price" style="font-weight: bolder;font-size: xx-large">$179</span>
<!---->
<!--                                            <span class="cd-currency">$</span>-->
<!--                                            <span class="cd-value">179*</span>-->
                        ...
                        <ul class="cd-pricing-wrapper">
                            <li id="singlesite_tab" data-type="singlesite" class="mosslp is-visible" style="border: <?php echo $sseborder; ?>">
                                 <header class="cd-pricing-header" style="height: 230px">
                                        ...
                                        <div class="cd-price" ><br>
                                            <span id="pro_total_price" style="font-weight: bolder;font-size: xx-large">$249</span>
                                ...
                                <a id="popover5" data-toggle="popover" title="<h3>Why should I choose this plan?</h3>" data-placement="top" data-html="true"
                                   data-content="<p>We are Single Sign-On experts. Talk to us for your Single Sign-On requirement. Our technical lead will contact you and will help you in designing the SSO architecture for you.</p>">
                                    <header class="cd-pricing-header" style="height: 282px">
                                        <h2 style="margin-bottom:10px;">Multiple LDAP directories<br/><br/></h2>
                                        <div class="cd-price" ><br>
                                            <span id="multiple_pro_total_price" style="font-weight: bolder;font-size: xx-large">$249</span>
