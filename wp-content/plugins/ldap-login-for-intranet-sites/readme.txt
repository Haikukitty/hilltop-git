...
Tags: active directory, ldap, authentication, ldap authentication, active directory integration, AD, ldap login, ldap sso, AD sso, AD authentication, active directory authentication, ldap single sign on, ad single sign on, ad login, active directory single sign on, openldap login, login form, user login, login, WordPress login,adfs, Active Directory SSO, LDAP SSO
Requires at least: 2.0.2
Tested up to: 5.0.1
Stable tag: 3.0.3
License URI: http://www.gnu.org/licenses/gpl-2.0.html

Active Directory Integration for Intranet sites supports login using credentials stored in Active Directory, OpenLDAP, OpenDS and directory systems. ACTIVE SUPPORT PROVIDED.
