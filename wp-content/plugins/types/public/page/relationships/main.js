...
Types.page.relationships.Class = function() {
    ...
    self.loadDependencies = function (nextStep) {
        ...
        Types.head.load(
            ...
            Types.page.relationships.jsPath + '/viewmodels/dialogs/MergeRelationships.js',
            nextStep
        );
    };
    ...
    self.getPotentialIntermediaryPostTypes = function() {
        return self.modelData['potentialIntermediaryPostTypes'];
    };
    ...
    self.editRelationship = function(relationshipDefinition) {
        ...
        jQuery( '#types_relationship_settings-hide, #types_relationship_settings .hndle' ).on( 'click', function() {
            ...
            setTimeout( function() { overlayHeight(); }, 50 );
            setTimeout( function() { overlayHeight(); }, 200 );
            setTimeout( function() { overlayHeight(); }, 500 );
            setTimeout( function() { overlayHeight(); }, 1000 );
        } );
