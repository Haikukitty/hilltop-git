...
class Types_Page_Relationships extends Types_Page_Persistent {
	 ...
	 * @param null|Toolset_Relationship_Definition_Repository $relationship_definition_repository_di PHPUnit dependency
	 *     injection.
	 */
	public function __construct(
		...
		$this->field_type_definition_factory = $field_type_definition_factory_di ? : Toolset_Field_Type_Definition_Factory::get_instance();
		...
		return array(
			'misc' => array(
				...
				'helpTexts' => array(
					...
					'chooseHowToConnectPosts' => sprintf( __( 'Choose how to connect between posts. Need help? Read <a href="%1$s" title="%2$s" target="_blank">what different post relationships mean</a>%3$s.', 'wpcf' ), 'https://toolset.com/documentation/post-relationships/', '', $external_icon ),
		...
		return array(
			...
			'strings' => array(
				...
				'wizard' => array(
					...
					'translatableWarning' => sprintf( __( 'Your site is multilingual and we recommend that you learn <a href="%s" target="_blank">how to translate related content</a>.', 'wpcf' ), 'https://toolset.com/documentation/translating-sites-built-with-toolset/translating-related-content/' ),
				),
