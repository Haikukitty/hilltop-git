...
class FormWidget extends ToolsetElementorWidgetBase {
	...
	public function get_title() {
		return __( 'Toolset Form', 'wp-cred' );
	}
		...
		switch ( $resource_to_edit ) {
			case 'post':
				...
				if (
					...
					$another_resource_error = '' === $another_post ? __( 'The Toolset Form widget displays a "Post edit" form, but no post to edit was selected.', 'wp-cred' ) : '';
				}
				break;
			case 'user':
				...
				if (
					...
					$another_resource_error = '' === $another_user ? __( 'The Toolset Form widget displays a "User edit" form, but no user to edit was selected.', 'wp-cred' ) : '';
				}
				break;
		}
	...
	public function register_editor_preview_widget_scripts() {
		...
		wp_localize_script(
			...
			array(
				...
				'selectFormFirstMessage' => __( 'Please, select a Form first!', 'wp-cred' ),
