			...
			?>
				<div class="logo_container">
					...
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
						<img src="/wp-content/uploads/2018/07/hilltop-umbc-color-4.png" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" id="logo" class="second-logo" data-height-percentage="<?php echo esc_attr( et_get_option( 'logo_height', '54' ) ); ?>" />
					</a>
