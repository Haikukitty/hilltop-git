	...
	<div class="content">
		...
		<table border="1" cellpadding="4" cellspacing="0" bordercolor="black">
			...
			<tr class="headerCell">
				...
				<td align="center" valign="bottom" id="cbrmap">Community Benefit Requirement<br>
				<a href="#" class="cbrmap" >
				<img src="/wp-content/uploads/hcbp/usmap_sm.gif" border="0"></a></td>
				
				<td align="center" valign="bottom" id="mmcbrmap">Minimum Community Benefit Requirement<br>
				<a href="#" class="mmcbrmap" >
				<img src="/wp-content/uploads/hcbp/usmap_sm.gif" border="0"></a></td>
				
				<td align="center" valign="bottom" id="cbrrmap">Community Benefit Reporting Requirement<br>
				<a href="#" class="cbrrmap" >
				<img src="/wp-content/uploads/hcbp/usmap_sm.gif" border="0"></a></td>
				
				<td align="center" valign="bottom" id="chnamap">Community Health Needs Assessment<br>
				<a href="#" class="chnamap" >
				<img src="/wp-content/uploads/hcbp/usmap_sm.gif" border="0"></a></td>
				
				<td align="center" valign="bottom" id="cbpismap">Community Benefits Plan/ Implementation Strategy<br>
				<a href="#" class="cbpismap" >
				<img src="/wp-content/uploads/hcbp/usmap_sm.gif" border="0"></a></td>
				
				<td align="center" valign="bottom" id="fapmap">Financial Assistance Policy<br>
				<a href="#" class="fapmap" >
				<img src="/wp-content/uploads/hcbp/usmap_sm.gif" border="0"></a></td>
				
				<td align="center" valign="bottom" id="fapdmap">Financial Assistance Policy Dissemination<br>
				<a href="#" class="fapdmap" >
				<img src="/wp-content/uploads/hcbp/usmap_sm.gif" border="0"></a></td>
				
				<td align="center" valign="bottom" id="lcbcmap">Limitations on Charges, Billing, and Collections<br>
...
<form action="/hcbp-state-comparison/?select=req" method="post" name="req" id="REQ">	

			<tr>
				<td align="right" valign="middle">&nbsp; </td>
				<td align="right" valign="middle">Filter: &nbsp; </td>
				<td align="center" valign="middle">
					<input type="checkbox" name="sel[]" value="cbr_cond" id="cbrbox1" class="cbrbox 
					<?php if (isset($_POST['sel[cbr_cond]'])) { echo "checked"; } ?>"> &nbsp; 
					<input type="checkbox" name="sel[]" id="cbrbox2" value="cbr_uncond" class="cbrbox
					<?php if (isset($_POST['sel[cbr_uncond]'])) { echo "checked"; } ?>">
				</td>

				<td align="center" valign="middle">
					<input type="checkbox" name="sel[]" value="mmcbr" class="check
					<?php if (isset($_POST['sel[mmcbr]'])) { echo "checked"; } ?>">
				</td>
				<td align="center" valign="middle">
					<input type="checkbox" name="sel[]" value="cbrr" class="check
				<?php if (isset($_POST['sel[cbrr]'])) { echo "checked"; } ?>">		</td>
				<td align="center" valign="middle">
					<input type="checkbox" name="sel[]" value="chna" class="check
				<?php if (isset($_POST['sel[chna]'])) { echo "checked"; } ?>">			</td>
				<td align="center" valign="middle">
					<input type="checkbox" name="sel[]" value="cbpis" class="check
					<?php if (isset($_POST['sel[cbpis]'])) { echo "checked"; } ?>">
				</td>
				<td align="center" valign="middle">
					<input type="checkbox" name="sel[]" value="fap" class="check
					<?php if (isset($_POST['sel[fap]'])) { echo "checked"; } ?>">
				</td>
				<td align="center" valign="middle">
					<input type="checkbox" name="sel[]" value="fapd" class="check
					<?php if (isset($_POST['sel[fapd]'])) { echo "checked"; } ?>">
				</td>
				<td align="center" valign="middle">
					<input type="checkbox" name="sel[]" value="lcbc" class="check
					<?php if (isset($_POST['sel[lcbc]'])) { echo "checked"; } ?>">
				</td>
				<td width="1" bgcolor="white" bordercolor="white" bordercolorlight="white"></td>
...
// CBPIS POPUP CONTAINER DIV CODE	 

	 jQuery('a.cbpistext').click(function(e) {
       e.preventDefault();
...
// jQuery('.dynamic-content.show').removeClass('show');
		...
		jQuery('#cbpis_text').modal();


    jQuery('#cbpisstate').html(stename);
		  jQuery('#cbpistext').html(stecontent);


	
	})
	 
// FAP POPUP CONTAINER DIV CODE	 

	 jQuery('a.faptext').click(function(e) {
       e.preventDefault();
...
// jQuery('.dynamic-content.show').removeClass('show');
		...
		jQuery('#fap_text').modal();


    jQuery('#fapstate').html(stename);
		  jQuery('#faptext').html(stecontent);


	
	})
	 
// FAPD POPUP CONTAINER DIV CODE	 

	 jQuery('a.fapdtext').click(function(e) {
       e.preventDefault();
...
// jQuery('.dynamic-content.show').removeClass('show');
		...
		jQuery('#fapd_text').modal();


    jQuery('#fapdstate').html(stename);
		  jQuery('#fapdtext').html(stecontent);


	
	})
	 
// LCBC POPUP CONTAINER DIV CODE	 

	 jQuery('a.lcbctext').click(function(e) {
       e.preventDefault();
...
// jQuery('.dynamic-content.show').removeClass('show');
		...
		jQuery('#lcbc_text').modal();


    jQuery('#lcbcstate').html(stename);
		  jQuery('#lcbctext').html(stecontent);


	
	})
	 
// ITE POPUP CONTAINER DIV CODE	 

	 jQuery('a.itetext').click(function(e) {
       e.preventDefault();
...
var stecontent = jQuery(this).attr("data-text");
 jQuery('.dynamic-content.show').removeClass('show');
		...
		jQuery('#ite_text').modal();


    jQuery('#itestate').html(stename);
		  jQuery('#itetext').html(stecontent);


	
	})
	 
// PTE POPUP CONTAINER DIV CODE	 
	 
	 jQuery('a.ptetext').click(function(e) {
       e.preventDefault();
...
var stecontent = jQuery(this).attr("data-text");
 jQuery('.dynamic-content.show').removeClass('show');
		...
		jQuery('#pte_text').modal();


    jQuery('#ptestate').html(stename);
		  jQuery('#ptetext').html(stecontent);
	
	})
	 
// STE POPUP CONTAINER DIV CODE	 
	 
	 jQuery('a.stetext').click(function(e) {
       e.preventDefault();
...
var stecontent = jQuery(this).attr("data-text");
 jQuery('.dynamic-content.show').removeClass('show');
		...
		// jQuery('#ste_text').addClass('show');

		jQuery('#ste_text').modal();

   jQuery('#stestate').html(stename);
		  jQuery('#stetext').html(stecontent);
